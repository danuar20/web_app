...
ALL_KPI_DEFS = [
    ...
    ("tchDropChart",       "TCH Drop",              "%",    0,    None,
     ...
     True),
    ("tchDropNumChart",    "TCH Drop Num",          "num",     0,    None,
    ...
    ("tchBlkChart",        "TCH Blocking",          "%",    0,    None,
     ...
     True),
    ("tchBlkNumChart",     "TCH Block Num",         "num",     0,    None,
    ...
    ("sdcchBlkChart",      "SDCCH Blocking",        "%",    0,    None,
     ...
     True),
    ("sdcchBlkNumChart",   "SDCCH Block Num",       "num",     0,    None,
     "ROUND(SUM(sdcch_block_num)::numeric, 0)",     True),
    ("fastRetChart",       "Fast Return to LTE",    "num",     0,    None,
