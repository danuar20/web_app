...
ALL_KPI_DEFS = [
    ...
    ("availChart",     "Availability",          "%",              "Availability (%)", 95, 100,
    ...
    ("erabSrChart",    "ERAB SR",                "%",              "ERAB SR (%)", 85, 100,
